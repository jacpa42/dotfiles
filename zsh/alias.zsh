...
alias l="eza --sort=type --long --no-time --no-user --header --colour always --icons always"
alias ll="eza --sort=type --long --colour always --icons always --git --all"
alias lll="eza --sort=type --total-size --long --colour always --icons always --git --all"
alias nv="clear && nvim"
alias snv="clear && sudo -E nvim"
alias u="clear && paru && echo && rustup update && echo && cargo install-update -a"
alias ff="fastfetch"
