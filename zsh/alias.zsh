...
alias l="eza --sort=type --long --no-time --no-user --header --colour always --icons"
alias ll="eza --sort=type --long --colour always --icons --git --all"
alias lll="eza --sort=type --total-size --long --colour always --icons --git --all"
alias nv="clear && nvim"
